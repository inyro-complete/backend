    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // 🟢 습득물 API (found-items) ← 수정된 부분
                        .requestMatchers(HttpMethod.GET, "/api/found-items").permitAll()  // ✅ 습득물 관현 모두 추가
                        .requestMatchers(HttpMethod.GET, "/api/found-items/*").permitAll() // ✅ 상세조회도 인증 없이
